...
class BatalDibeliWidget extends StatefulWidget {
  const BatalDibeliWidget({super.key});

  @override
  State<BatalDibeliWidget> createState() => _BatalDibeliWidgetState();
}

class _BatalDibeliWidgetState extends State<BatalDibeliWidget> {
